...
var  posLinha;
var img;
img - loadfile("imagens/")
var pacman = image(50,50);
cenario=  [
...
function FundoTela(){
  ...
  stroke(130,130,130);
   strokeWeight(1); 
    textSize(15);
    text("JAVA", 100, 70); text("JAVA", 275, 60); text("JAVA", 450, 60);
    text("JAVASCRIPT", 100, 140);text("JAVASCRIPT",275, 120);text("JAVASCRIPT", 450, 120);
    text("C++", 100, 185); text("C++",275, 175); text("C++", 450, 175);
    text("PHYTON", 100, 240); text("PHYTON", 275, 230);text("PHYTON", 450, 230);
    text("C#", 100, 310);text("C#", 275, 300);text("C#", 450, 300);
    text("JAVASCRIPT", 110, 380);text("JAVASCRIPT",275, 375);text("JAVASCRIPT", 450, 375);
    text("JAVA", 100, 460); text("JAVA", 275, 450); text("JAVA", 450, 450);    
